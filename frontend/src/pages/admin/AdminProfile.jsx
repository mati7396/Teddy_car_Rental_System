            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Manage your personal information and public profile.</p>
                    </div>
                </div>
                        ...
                        <Card className="border-border/60 shadow-md">
                            <CardContent className="pt-8 flex flex-col items-center text-center">
                                <div className="relative group">
                                    <Avatar className="h-32 w-32 border-4 border-primary/10 shadow-xl">
                                        ...
                                        <AvatarFallback className="bg-primary/5 text-primary text-3xl font-bold">
                                            {formData.firstName?.[0] || 'A'}{formData.lastName?.[0] || 'D'}
                                        </AvatarFallback>
                                    </Avatar>
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="text-sm text-muted-foreground uppercase tracking-widest font-bold mt-1">Administrator</p>
